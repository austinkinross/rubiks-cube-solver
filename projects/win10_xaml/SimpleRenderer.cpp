...
GLuint CompileShader2(GLenum type, const std::string &source)
{
...
GLuint CompileProgram2(const std::string &vsSource, const std::string &fsSource)
{
    ...
    GLuint vs = CompileShader2(GL_VERTEX_SHADER, vsSource);
    GLuint fs = CompileShader2(GL_FRAGMENT_SHADER, fsSource);
    ...
    mDrawCount(0)
{
    ...
    mProgram = CompileProgram2(vs, fs);
